...
<script>
   ...
   <div class="infoo-head">
       <label>اطلاعات تماس</label>
           ...
           <div class="contact-item contact__email">
               ...
               <span>ایمیل:</span>
               <span>mahdiye9sunsky@gmail.com</span>
           </div>
   <div class="contact-item contact__mobile">
               ...
               <span>موبایل:</span>
               <span style="unicode-bidi:embed" dir="ltr">(+۹۸)۹۰۱۶۶۵۶۳۰۵</span>
   </div>
       ...
       <div class="property-item_body">
           <div class="bar-progress item-row w0">
               <ul class="history">
                       <li>
                           <span>
                               <label> تنظیم و هماهنگ کننده امور ، روابط عمومی </label>
                                   <label class="grade">
                                       <small>100%</small>
                                           <i class="tik"></i>
                                           <i class="tik"></i>
                       ...
                       <li>
                           <span>
                               <label>ارتباطات و روابط عمومی</label>
                                   <label class="grade">
                                       <small>100%</small>
                                           <i class="tik"></i>
                                           <i class="tik"></i>
                   ...
                   <ul class="history">
                           <li>
                               <div class="c100 p100 small">
                                   ...
                                   <div class="circle-progress__title"> تنظیم و هماهنگ کننده امور ، روابط عمومی </div>
                               </div>
                           </li>
                           <li>
                               <div class="c100 p100 small">
                                   ...
                                   <div class="circle-progress__title">ارتباطات و روابط عمومی</div>
                               </div>
                           </li>
                           <li>
                           ...
                           <li>
                               <div class="c100 p60 small">
                                   ...
                                   <div class="circle-progress__title"> برنامه نویسی java</div>
                               </div>
                           </li>
                           <li>
                               <div class="c100 p60 small">
                       ...
                       <li>
                           <span>
                               <label>
                                   ...
                                   <label dir="ltr"><a rel="nofollow noreferrer" class="social-link" href="https://twitter.com/mahdiye_pq" target="_blank">mahdiye_pq</a></label>
                       ...
                       <li>
                           <span>
                               <label>
                                   ...
                                   <label dir="ltr"><a rel="nofollow noreferrer" class="social-link" href="https://instagram.com/mahdiye_pq" target="_blank">mahdiye_pq</a></label>
                       ...
                       <li>
                           <span>
                               <label>
                                   ...
                                   <label dir="ltr"><a rel="nofollow noreferrer" class="social-link" href="https://t.me/mah_pq" target="_blank">mah_pq</a></label>
...
شرکت: چوب و هنر
                               ...
                               <label class="date">آغاز همکاری از تیر ۱۳۹۸</label>
...
شرکت: اسنپ
                               ...
                               <label class="date">مرداد ۱۳۹۷ - شهریور ۱۳۹۷</label>
...
div.contact-item span:last-child {
 font-size: 12px;
 display: inline-block;
 width: 210px;
 text-align: right;
...
div.contact-item span:first-child i {
 width: 20px;
 height: 20px;
 color: white;
...
.lgbox .property-item_body {
 border-right: 2px solid #0d0d0d;
 float: right;
 border-left-color: #0d0d0d !important;
}
.lgbox .property-item_head label:before {
 content: '';
 position: absolute;
 width: 7px;
 height: 7px;
...
.basic__about .property-item_body {
 padding-top: 0;
}
.infoo-head {
 display: none;
...
.smbox div.item-row li > span {
 width: 100%;
 padding-left: 0;
}
.lgbox .skill__list ul.history {
 padding-left: 0;
}
...
.lgbox div.item-row li > span label:first-child {
 width: 175px;
 padding-right: 12px;
}
.lgbox h2.subtitle.language-item ~ span label:first-child {
 width: 103px;
}
ul.history li {
 margin-bottom: 5px !important;
}
.lgbox .language__list div.item-row li > span {
 margin: 15px 0;
}
...
.other-infos > div span:first-child:before {
 content: '';
 position: absolute;
 width: 8px;
 height: 8px;
